...
public class HttpRequestInterceptor implements HandlerInterceptor {
  ...
  @Resource
  private UploadFileFullProperties properties;
  ...
  public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
    ...
    if (properties.getInnerProperties().isEnabledLogger())
    ...
    if (properties.getInnerProperties().isEnabledLogger())
      log.info(CommonUtils.getCommonPrefixAndSuffix(String.format("Intercepted response: %s", entity.toString())));
